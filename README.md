...
Las versiones optimizadas se encuentran en los ficheros ***reverse_int_opt.s** y **reverse_int_opt_inl.c**.
...
Para limpiar los ficheros .o, utilizar:
  ```
  make clean
  ```

Para eliminar todos los ficheros intermedios, utilizar:
  ```
  make cleanall
  ```
