...
Las versones optimizadas se encuentran en los ficheros ***reverse_int_opt**, con el .c conteniendo la versión con ensamblador in-line y el .s conteniendo la versión completamente en ensamblador.
